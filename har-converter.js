...
// First run below command to manually execute steps which will generate HAR file
// npx playwright codegen --save-har=networking.har https://conduit.bondaracademy.com/ 
// then run this command to parse har file, node har-converter.js
